...
const {data: landingpage1, pending, error} = await useAsyncData('landingpage', async () => {
  ...
  try {
    const response = await $fetch("http://bubbletea-werl.de:8080/auth/honorare", {
      method: 'GET',
      headers: {
...
const {data: escortPreise1, pending2, error2} = await useAsyncData('escortPreise', async () => {
  ...
  try {
    const response = await $fetch("http://bubbletea-werl.de:8080/auth/escortpreise", {
      method: 'GET',
      headers: {
        Authorization: token ? `Bearer ${token}` : undefined,
      },
...
const {data: dinnerPreise1, pending3, error3} = await useAsyncData('dinnerPreise', async () => {
  ...
  try {
    const response = await $fetch("http://bubbletea-werl.de:8080/auth/dinnerpreise", {
      method: 'GET',
      headers: {
        Authorization: token ? `Bearer ${token}` : undefined,
      },
