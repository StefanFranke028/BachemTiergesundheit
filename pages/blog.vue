<template>
  <div >
    ...
    <div >
      <v-row v-for="(blog , index) in blogs" :key="blog" style="width: 100%; height: 100%; min-height: 500px" class="ma-0 pa-0">
        <v-col style="background-color: #d4e2ea" class="" cols="12">
          <v-row  style="width: 100%; height: 100%; border: 1px black solid" class="ma-0">
            <v-col cols="6">
