          ...
          >
            ...
            <v-row style="width: 100%;" class="ma-0">
              <v-col cols="12" class="d-flex justify-center">
                <a :href="'https://' + preis.link"
                   :title="preis.ueberschrift ? `Zum Produkt: ${preis.ueberschrift}` : 'Zum Produkt'"
                   itemprop="url" style="text-decoration: none" rel="noopener" target="_blank">
                  <v-btn class="mt-5"
          ...
          >
            ...
            <v-row style="width: 100%;" class="ma-0">
              <v-col cols="12" class="d-flex justify-center">
                <a :href="preis.link"
                   :title="preis.ueberschrift ? `Zum Produkt: ${preis.ueberschrift}` : 'Zum Produkt'"
                   rel="noopener" style="text-decoration: none" target="_blank">
                  <v-btn class="mt-5"
                         style="background-color: rgb(0, 130, 194); color: white; border-radius: 20px">
                    Zum Produkt ›
                  </v-btn>
