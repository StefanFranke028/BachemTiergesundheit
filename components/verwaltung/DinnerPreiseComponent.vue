...
export default {
  ...
  methods: {
    async getDinnerPreise() {
      try {
        let response = await $fetch(`http://85.215.175.241:8080/auth/dinnerpreise`, {
          method: 'GET',
        });
    ...
    async submitChanges() {
      ...
      try {
        ...
        if (this.editDinnerPreis) {
          ...
          response = await $fetch(`http://85.215.175.241:8080/auth/dinnerpreise/${this.editDinnerPreis.id}`, {
            method: 'PUT',
            body: data
          });
          ...
          response = await $fetch(`http://85.215.175.241:8080/auth/dinnerpreise`, {
            method: 'POST',
            body: data
          });
    ...
    async confirmDelete() {
      ...
      try {
        let response = await $fetch(`http://85.215.175.241:8080/auth/dinnerpreise/${this.dinnerPreisToDelete.id}`, {
          method: 'DELETE',
        });
